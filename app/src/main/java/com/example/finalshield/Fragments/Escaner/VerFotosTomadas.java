...
public class VerFotosTomadas extends Fragment implements View.OnClickListener, ImageAdapter.Callbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ver_fotos_tomadas, container, false);
    }
            ...
            if (filePaths != null) {
                for (String path : filePaths) {
                    ...
                    if (file.exists()) {
                        ...
                        Log.w("Visualizador", "Archivo no encontrado: " + path);
                    }
                }
            }
        }
    ...
    private void descartarFotosSeleccionadas() {
        ...
        for (Uri uri : discardedUris) {
            try {
                // se intenta obtener el archivo desde la URI
                File fileToDelete = new File(uri.getPath());
                if (fileToDelete.exists() && fileToDelete.delete()) {
                    Log.d("Visualizador", "Archivo descartado eliminado: " + fileToDelete.getName());
                } else {
                    // si no funciono, intenta con ContentResolver
        ...
        //si no quedan fotos, vuelve automáticamente
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.regresar1) {
            // los archivos restantes se dejan en el disco
            ...
            if (adapter != null) {
                ...
                if (retainedUris.isEmpty()) {
                    ...
                    // Lógica de guardado y cifrado xd
                    Navigation.findNavController(v).popBackStack();
                }
            }
        }
    }
    // abrir la Activity de visualización
    @Override
    public void onImageClicked(Uri uri) {
        ...
        // es necesario otorgar permiso de lectura temporalmente para la URI del FileProvider
