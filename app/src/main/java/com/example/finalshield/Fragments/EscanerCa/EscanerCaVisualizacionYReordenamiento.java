...
public class EscanerCaVisualizacionYReordenamiento extends Fragment implements View.OnClickListener {
    ImageButton cam1, addele1, eliminar1, recortar1;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_escaner_ca_visualizacion_y_reordenamiento, container, false);
    }
